...
For the annotation of a viral genome against the IVON provided databases we suggest using the python code provided below. This script will annotate yours genome using DIAMOND, however the script can easily be adapted to run your local sequence aligner (LSA) of choice. 
